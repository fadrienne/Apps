---
name: cross-linker
description: "Scan recent or specified notes for missing wikilinks. Finds mentions that should be linked but aren't. Suggests missing bidirectional links for user approval."
...
- For each orphan, suggest which notes should link to it.
...
Write findings to `thinking/cross-link-audit-YYYY-MM-DD.md`. DO NOT auto-fix links — present all findings for user approval. Group by severity:
