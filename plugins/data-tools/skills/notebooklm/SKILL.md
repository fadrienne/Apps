---
name: notebooklm
description: Complete programmatic access to Google NotebookLM, including capabilities not exposed in the web UI. Use when creating notebooks, adding sources (URLs, YouTube, PDFs, audio, video, images), chatting with notebook content, generating artifacts (audio overviews, summaries, etc.), or downloading NotebookLM results in various formats.
---
