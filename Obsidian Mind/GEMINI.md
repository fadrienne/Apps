...
**Memory System** (`Obsidian Mind/brain/`): Plain markdown files including "Memories," "Patterns," "Key Decisions," and "Gotchas." When you learn something worth remembering, write it to the relevant `Obsidian Mind/brain/` topic note with a wikilink to context.
