...
**Memory System**: The `Obsidian Mind/brain/` directory stores persistent knowledge in plain markdown files (Memories.md, Patterns.md, Key Decisions.md, Gotchas.md). This vault-side memory is "the source of truth" across all agents, separate from Claude Code's auto-loaded `~/.claude/` memory.
